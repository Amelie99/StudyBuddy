...
const initialConversations: Conversation[] = [
  ...
  { id: "group-1", name: "Mathe Profis WS23/24", lastMessage: "Max: Ich lade die neue Version hoch.", timestamp: "Gestern", unread: 3, avatar: "https://i.imgur.com/s4M5N0Q.png", dataAiHint: "group icon" },
