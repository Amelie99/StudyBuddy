...
const initialConversations: Conversation[] = [
  ...
  { id: "2", name: "David Meier", lastMessage: "Können wir uns morgen treffen?", timestamp: "10:30", unread: 0, avatar: "https://placehold.co/100x100.png", dataAiHint: "man library" },
...
const initialChats: { [key: string]: ChatDetail } = {
    ...
    "2": { id: "2", name: "David Meier", avatar: "https://placehold.co/100x100.png", dataAiHint: "man library", type: "user", messages: [ { id: "dm1", senderId: "user2", text: "Können wir uns morgen treffen?", timestamp: "10:30", self: false }, ] },
